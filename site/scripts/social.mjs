...
<g font-family="sans-serif" font-size="68" font-weight="500" letter-spacing="-3"><text x="55" y="260" fill="${token('text')}">Parallel coding.</text><text x="55" y="335" fill="${token('accent')}">Without losing</text><text x="55" y="410" fill="${token('accent')}">the thread.</text></g>
<text x="60" y="480" font-family="sans-serif" font-size="22" fill="${token('text-secondary')}">The desktop workspace for the pi coding agent.</text>
