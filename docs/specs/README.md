...
| [headroom-compression.md](headroom-compression.md) | Implementation plan for Headroom compression across both harnesses, plus the traps and the partnership asks. | Measurements and traps yes. Nothing in it is built.                                                         |
| [optimization-surface.md](optimization-surface.md) | proposed                                                                                                     | The Optimization settings tab, per-lane savings, and the efficiency Advisor — UI half of the Headroom work. |
