...
| [headroom-compression.md](headroom-compression.md) | Research + design for attaching Headroom's context compression to pi as a bundled extension. | Measurements yes. Nothing in it is built.      |
