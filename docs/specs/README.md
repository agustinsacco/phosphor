...
| [context-proxy-headroom.md](context-proxy-headroom.md) | A proposal to put the Headroom compression proxy between pidex sessions and the model, as a middleman. | For the code paths it cites, yes. For what Headroom would do to pidex, **no** — the spike has not run. |
